export const EXPERIENCE = [
  {
    ...
    points: [
      "Deployed various self-service tools for customers to manage their care, automated outreach, and compiled usage reports.",
    ],
  },
  {
...
export const SKILLS = {
  Programming: [
    'Python', 'Java', 'C', 'C++', 'Bash', 'CSS', 'JavaScript', 'TypeScript', 'Rust',
  ],
