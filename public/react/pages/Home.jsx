(() => {
        ...
        <div className="container hero">
          <div>
            ...
            <div className="hero-cta">
              ...
              <a className="btn" href="#/resume" rel="noreferrer"><i className="fa-regular fa-file-lines"/> View resume</a>
            </div>
          </div>
  ...
  function ProjectsSection({ filters, setFilters, toggleTag, clearFilters, hoverTag, setHoverTag }) {
    ...
    // Re-attach reveal observers when filter set changes so newly rendered cards appear
  ...
  function Home() {
    ...
    return (
      <>
        ...
        <About />
        <ExperienceSection />
        <ProjectsSection filters={filters} setFilters={setFilters} toggleTag={toggleTag} clearFilters={clearFilters} hoverTag={hoverTag} setHoverTag={setHoverTag} />
